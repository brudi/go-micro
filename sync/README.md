...
```go
import "github.com/brudi/go-micro/sync/lock/consul"
...
import (
	...
	"github.com/brudi/go-micro/sync/leader/consul"
)
...
```go
import (
	"github.com/brudi/go-micro/sync/task"
	"github.com/brudi/go-micro/sync/task/local"
)
...
```go
import (
	"github.com/brudi/go-micro/sync/time/ntp"
)
